...
//
//     final commentUserModel = commentUserModelFromJson(jsonString);

import 'dart:convert';

CommentUserModel commentUserModelFromJson(String str) =>
    CommentUserModel.fromJson(json.decode(str));

String commentUserModelToJson(CommentUserModel data) =>
